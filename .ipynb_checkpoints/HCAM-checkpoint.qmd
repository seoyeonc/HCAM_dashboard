...
camimg = torch.einsum('ij,jkl -> ikl', net2_r[2].weight, net1_r(x_cat_r).squeeze())
...
```{python}
#| title: Original pets of Other Methods
# GradCAM
...
```{python}
#| title: Randombox pets of Other Methods
