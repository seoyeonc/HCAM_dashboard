...
```{python}
#| title: a Randombox Cat of HCAM(Mode 1)
...
with open('hcam_cat2_plt.pkl', 'rb') as file:
    hcam_cat_plt = pickle.load(file)
hcam_cat_plt.show()
...
```{python}
#| title: a Randombox Dog of HCAM(Mode 1)

import pickle

with open('hcam_dog_plt1.pkl', 'rb') as file:
...
with open('hcam_dog_plt2.pkl', 'rb') as file:
    hcam_dog_plt = pickle.load(file)
hcam_dog_plt.show()
...
with open('hcam_dog_plt3.pkl', 'rb') as file:
    hcam_dog_plt = pickle.load(file)
hcam_dog_plt.show()
...
with open('hcam_dog_plt4.pkl', 'rb') as file:
    hcam_dog_plt = pickle.load(file)
hcam_dog_plt.show()
